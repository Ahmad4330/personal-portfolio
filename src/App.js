import pic from "./linked.png";
import pic1 from "./indeed.png";
import pic2 from "./twitter.png";
import pic3 from "./center.jpg";
...
function App() {
  return (
    <>
      ...
      <div className="basic" id="home">
        <h5>Hello I'm</h5>
        <h1>Muhammd Ahmad</h1>
        <h5 className="cls">Front End Web Developer</h5>
        <div className="buton">
          <a href="ahmad.pdf" download>
      ...
      <div className="home">
        <div className="section1">
          <a href="https://www.linkedin.com/">
            <img src={pic} alt="" className="imgg" />
          </a>
          <a href="https://pk.indeed.com/">
            <img src={pic1} alt="" className="imgg" />
          </a>
          <a href="https://twitter.com">
            <img src={pic2} alt="" className="imgg1" />
          </a>
        </div>
        ...
        <div className="left">
          ...
          <div className="para">
            <p>
              ...
              experience using HTML SCSS & JavaScript to build accessible
              component-based web pages and systems. A passionate person willing
              to learn more technologies to become a better developer than i was
              yesterday. So determined and result orietend.
            </p>
          </div>
      ...
      <div className="aboutHeading1" id="experience">
        ...
        <div className="frontend">
          ...
          <div className="for">
            <div className="box11">
              ...
              <div className="html">
                <h4>HTML</h4>
                <small className="inter">Intermediate</small>
              </div>
            </div>
            <div className="box22">
              <div className="icon">
          ...
          <div className="for1">
            ...
            <div className="box22">
              ...
              <div className="html">
                <h4>JavaScript</h4>
                <small className="small1">Beginner</small>
              </div>
            </div>
          </div>
      ...
      <div className="aboutHeading2" id="contact">
        <h4>Get In Toch</h4>
        <h1>Contact Me</h1>
      </div>
      <div className="contact">
        <div className="contact-box">
          <div className="whatsaap">
            ...
            <h4>Email</h4>
            <p>ahmadshoukat4330@gmail.com</p>
        ...
        <div className="forms">
          ...
          <button className="btn3">Lets Talk</button>
        </div>
      </div>
      <div className="footer">
        ...
        <div className="last">
          <h5>© Muhammad_Ahmad. All rights reserved.</h5>
        </div>
      </div>
    </>
  );
